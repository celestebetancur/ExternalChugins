...
Compilation options: -a .faust2ck_tmp/Panner.dsp-wrapper.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a .faust2ck_tmp/Panner.dsp-wrapper.cpp -lang cpp -es 1 -mcd 16 -single -ftz 0");
